...
import com.wli.mediapicker.crop.aspectratio.model.AspectRatio.ASPECT_FREE
import com.wli.mediapicker.crop.cropview.AspectMode.ASPECT
import com.wli.mediapicker.crop.cropview.AspectMode.FREE
import com.wli.mediapicker.crop.main.CropTheme
import com.wli.mediapicker.crop.ui.CroppedBitmapData
import com.wli.mediapicker.crop.util.extensions.animateScaleToPoint
import com.wli.mediapicker.crop.util.extensions.animateTo
import com.wli.mediapicker.crop.util.extensions.animateToMatrix
import com.wli.mediapicker.crop.util.extensions.clone
import com.wli.mediapicker.crop.util.extensions.getCornerTouch
import com.wli.mediapicker.crop.util.extensions.getEdgeTouch
import com.wli.mediapicker.crop.util.extensions.getHypotenus
import com.wli.mediapicker.crop.util.model.AnimatableRectF
import com.wli.mediapicker.crop.util.model.Corner
...
import com.wli.mediapicker.crop.util.model.DraggingState
import com.wli.mediapicker.crop.util.model.DraggingState.DraggingCorner
import com.wli.mediapicker.crop.util.model.DraggingState.DraggingEdge
import com.wli.mediapicker.crop.util.model.Edge
